...
class Promise<RESULT> private constructor(
    ...
    private val timeoutSN = AtomicLong()
    ...
    private val cancelledBroadcast = PromiseCancelledBroadcaster()
    ...
    private fun succeed(v: RESULT) {
        settle(Status.SUCCEED) { value = v }
    }

    private fun fail(e: Throwable) {
        settle(Status.FAILED) { reason = e }
    }
